    ...
    <div className="glass-card p-8 animate-slide-up">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="block text-sm text-white/50">Password</label>
            <Link href="/forgot-password" className="text-xs hover:opacity-80 transition" style={{ color: "#7C5CFF" }}>
              Forgot password?
            </Link>
          </div>
          <input
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-white/35">
          ...
          <Link href="/register" className="font-medium hover:opacity-80 transition" style={{ color: "#00AAFF" }}>
            Create one
          </Link>
        </p>
      </div>
