...
const navigation = [
  ...
  { nameKey: "nav.fb_action_bot", href: "/fb-action-bot", icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" },
...
const fbAdsNavigation = [
  ...
  { nameKey: "nav.fb_live_sell", href: "/fb-ads/live-sell", icon: "M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" },
];
