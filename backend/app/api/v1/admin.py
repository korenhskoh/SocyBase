...
FEATURE_FLAG_DEFAULTS = {
    ...
    "playwright_scraping": {"enabled": True, "description": "Enable Browser Operator (Chrome extension CDP) for scraping Facebook comments. When disabled, only AKNG API is used."},
}
